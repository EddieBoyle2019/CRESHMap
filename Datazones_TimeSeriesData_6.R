...
master_data_2024 <- read_csv("Datazones_TimeSeriesData_2024_update_smoking.csv")
...
master_data_2024 %>%
  ...
  left_join(smoking_data_2020[c('DataZone2011Code', 'tobacco_density', 'nvp_density')], by = c('DataZone11_ID' = 'DataZone2011Code')) %>%
