...
smoking_data_2024 <- read_csv("smoking_data_transformed.csv")

#SmR24_All_PopAdjCnt
master_data_2024 %>%
  #add 2024 smoking densities
  left_join(smoking_data_2024[c('DataZone2011Code', 'tobacco_density', 'nvp_density')], by = c('DataZone11_ID' = 'DataZone2011Code')) %>%
...
master_data_2024_smoking %>%
  select(DataZone11_ID, NameDZ11, MidYr2012DZPop, MidYr2016DZPop, MidYr2020DZPop, MidYr2021DZPop, AR12_All_PopAdjCnt, AR12_On_PopAdjCnt, AR12_Off_PopAdjCnt, TR12_PopAdjCnt, AR16_All_PopAdjCnt,AR16_On_PopAdjCnt, AR16_Off_PopAdjCnt, TR16_PopAdjCnt, AR20_All_PopAdjCnt, AR20_On_PopAdjCnt, AR20_Off_PopAdjCnt, TR20_PopAdjCnt, AR23_All_PopAdjCnt, AR23_On_PopAdjCnt, AR23_Off_PopAdjCnt, GR23_PopAdjCnt, FR24_PopAdjCnt, SR24_PopAdjCnt, SmR24_Tob_PopAdjCnt, SmR24_Nvp_PopAdjCnt, PopDen_2012psqkm, PopDen_2016psqkm, PopDen_2020psqkm) -> master_data_2024_4
    
## Export data
write.csv(master_data_2024_4, "Datazones_TimeSeriesData_2024_update_smoking.csv", row.names = FALSE)
